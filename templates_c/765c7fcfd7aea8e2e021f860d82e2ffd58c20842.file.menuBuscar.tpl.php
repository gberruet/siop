<?php /* Smarty version Smarty-3.1.15, created on 2016-11-16 22:58:21
         compiled from ".\templates\menuBuscar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25785582ca0448b4847-14911320%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '765c7fcfd7aea8e2e021f860d82e2ffd58c20842' => 
    array (
      0 => '.\\templates\\menuBuscar.tpl',
      1 => 1479333500,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '25785582ca0448b4847-14911320',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_582ca044941245_96558263',
  'variables' => 
  array (
    'datosEdificios' => 0,
    'item' => 0,
...
<?php if ($_valid && !is_callable('content_582ca044941245_96558263')) {function content_582ca044941245_96558263($_smarty_tpl) {?>    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
 ...
 $_from = $_smarty_tpl->tpl_vars['datosEdificios']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['idEdificio'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['idEdificio'];?>
 - <?php echo $_smarty_tpl->tpl_vars['item']->value['nombre'];?>
              ...
              <td class="warning" colspan="23">
                <select name="sector" class="form-control">
                  ...
                  <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['datosSectores']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['idSector'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['idSector'];?>
 - <?php echo $_smarty_tpl->tpl_vars['item']->value['nombre'];?>
</option>
                  <?php } ?>
                </select>
              ...
              <td class="danger" colspan="23">
                <select name="puesto" class="form-control">
                  ...
                  <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['datosPuestos']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['idPuesto'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['idPuesto'];?>
 - <?php echo $_smarty_tpl->tpl_vars['item']->value['nombre'];?>
</option>
                  <?php } ?>
                </select>
